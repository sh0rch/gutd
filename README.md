...
|---|---|---|---|
| **gutd (eBPF)** ([v2.5.0](https://github.com/sh0rch/gutd/releases/tag/v2.5.0)) | 891 Mbits/sec | 834 Mbits/sec | 0% |
| **gutd (Userspace)** ([v2.5.0](https://github.com/sh0rch/gutd/releases/tag/v2.5.0)) | 894 Mbits/sec | 659 Mbits/sec | 19% |
| **wg-obfuscator** ([v1.5](https://github.com/ClusterM/wg-obfuscator/releases)) | 381 Mbits/sec | 310 Mbits/sec | 79% |
<sub><i>* Performance measured using `iperf3` between 2 isolated network namespaces on GitHub Actions Ubuntu 22.04 runners. [See test logic and full logs](https://github.com/sh0rch/gutd/actions/runs/23075723273). Last updated: 2026-03-14 00:16</i></sub>
