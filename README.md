...
|---|---|---|---|
| **gutd** ([v2.1.0](https://github.com/sh0rch/gutd/releases/tag/v2.1.0)) | 935 Mbits/sec | 933 Mbits/sec | 0% |
| **wg-obfuscator** ([v1.5](https://github.com/ClusterM/wg-obfuscator/releases)) | 345 Mbits/sec | 256 Mbits/sec | 73% |
