...
|---|---|---|---|
| **gutd (eBPF)** ([v2.5.0](https://github.com/sh0rch/gutd/releases/tag/v2.5.0)) | 889 Mbits/sec | 852 Mbits/sec | 0% |
| **gutd (Userspace)** ([v2.5.0](https://github.com/sh0rch/gutd/releases/tag/v2.5.0)) | 1.44 Gbits/sec | 1.05 Gbits/sec | 28% |
| **wg-obfuscator** ([v1.5](https://github.com/ClusterM/wg-obfuscator/releases)) | 319 Mbits/sec | 256 Mbits/sec | 69% |
<sub><i>* Performance measured using `iperf3` between 2 isolated network namespaces on GitHub Actions Ubuntu 22.04 runners. [See test logic and full logs](https://github.com/sh0rch/gutd/actions/runs/23075816571). Last updated: 2026-03-14 00:20</i></sub>
