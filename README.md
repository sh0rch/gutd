...
| **gutd (Userspace)** ([v3.0.15](https://github.com/sh0rch/packetveil/releases/tag/v3.0.15)) | 592 Mbits/sec | 454 Mbits/sec | 52% |
| **wg-obfuscator** ([v1.5](https://github.com/ClusterM/wg-obfuscator/releases)) | 315 Mbits/sec | 221 Mbits/sec | 85% |
<sub><i>* Performance measured using `iperf3` between 2 isolated network namespaces on GitHub Actions Ubuntu 22.04 runners. [See test logic and full logs](https://github.com/sh0rch/packetveil/actions/runs/28407286821). Last updated: 2026-06-29 22:39</i></sub>
